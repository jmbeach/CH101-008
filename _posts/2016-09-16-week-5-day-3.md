...
+ Metallicelementsmakeupthemajorityoftheelementsin the periodic table.
  + Alkali Metals:
...
–  Halogens (group 7A) usually gain one electron to form –1 anions. –  Other nonmetals can form a variety of charged anions.
...
•  Atomsinthesamegroupincreaseinsizedown the column.
•  Atomicradiioftransitionmetalsareroughlythesame size across the d block.
...
M(g) + IE1 èM1+(g) + 1 e–
•  Second IE = energy to remove from 1+ ion, etc. M+1(g) + IE2 è M2+(g) + 1 e–
...
| isoelectronic | same number of electrons |
| | traversing down the periodic table, anions get larger or smaller? |
| | traversing down the periodic table, cations get larger or smaller? |
| ionization energy |
| | IE _ down the group |
| | IE _ across the period |
